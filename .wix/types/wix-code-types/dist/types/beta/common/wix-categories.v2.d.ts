declare module "wix-categories.v2" {
   ...
   *
   * > **Notes:**
   * > + If `position.BEFORE` is passed, then moveBeforeCategoryId must be provided.
   ...
   * @param item - Catalog item reference info
   * @internal
   * @documentationMaturity preview
   * @requiredField item
  ...
  /**
   * Returns a list of all trees installed on site sorted by `appNamespace` in ascending order.
   * A tree is automatically created the first time a category is added to it.
   * Each tree listed can be used when calling other endpoints in the API
   * @internal
   * @documentationMaturity preview
   */
