declare module "wix-domains.v1" {
   ...
   */
  function createConnectedDomain(connectedDomain: ConnectedDomain): Promise<ConnectedDomain>;
  /**
   ...
   * @adminMethod
   */
  function getConnectedDomainSetupInfo(connectedDomainId: string): Promise<GetConnectedDomainSetupInfoResponse>;
  /** @param domain - Domain name including TLD
   * @internal
   * @documentationMaturity preview
   * @requiredField domain
   * @adminMethod
   */
  function getDomainSetupInfo(domain: string, options?: GetDomainSetupInfoOptions): Promise<GetDomainSetupInfoResponse>;
  interface GetDomainSetupInfoOptions {
      /**
       * How the domain should be to connected the Wix site.
       *
       * + `"UNKNOWN_CONNECTION_TYPE"`: supported only for subdomain.
  ...
  type premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoRequest = GetDomainSetupInfoRequest;
  type premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoResponse = GetDomainSetupInfoResponse;
  ...
  const premiumDomainsV1ConnectedDomainSetupInfo_universal_d_getDomainSetupInfo: typeof getDomainSetupInfo;
  type premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoOptions = GetDomainSetupInfoOptions;
  namespace premiumDomainsV1ConnectedDomainSetupInfo_universal_d {
    export {
      ...
      premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoRequest as GetDomainSetupInfoRequest,
      premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoResponse as GetDomainSetupInfoResponse,
      ...
      premiumDomainsV1ConnectedDomainSetupInfo_universal_d_getDomainSetupInfo as getDomainSetupInfo,
      premiumDomainsV1ConnectedDomainSetupInfo_universal_d_GetDomainSetupInfoOptions as GetDomainSetupInfoOptions,
    };
  }
  ...
  type premiumDomainsV1RegisteredDomain_universal_d_CursorPaging = CursorPaging;
  type premiumDomainsV1RegisteredDomain_universal_d_ListRegisteredDomainsResponse = ListRegisteredDomainsResponse;
  type premiumDomainsV1RegisteredDomain_universal_d_CursorPagingMetadata = CursorPagingMetadata;
  type premiumDomainsV1RegisteredDomain_universal_d_Cursors = Cursors;
  ...
  namespace premiumDomainsV1RegisteredDomain_universal_d {
    export {
      ...
      premiumDomainsV1RegisteredDomain_universal_d_CursorPaging as CursorPaging,
      premiumDomainsV1RegisteredDomain_universal_d_ListRegisteredDomainsResponse as ListRegisteredDomainsResponse,
      premiumDomainsV1RegisteredDomain_universal_d_CursorPagingMetadata as CursorPagingMetadata,
      premiumDomainsV1RegisteredDomain_universal_d_Cursors as Cursors,
