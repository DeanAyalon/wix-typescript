declare module "wix-events.v2" {
  ...
  interface GuestsQueryResult extends QueryCursorResult$5 {
      items: EventGuest[];
  ...
  interface StaffMembersQueryResult extends QueryCursorResult$3 {
      items: StaffMember[];
  ...
  type eventsStaffmembersV1StaffMember_universal_d_ExtendedFields = ExtendedFields;
  ...
  namespace eventsStaffmembersV1StaffMember_universal_d {
    export {
      ...
      Status$4 as Status,
      eventsStaffmembersV1StaffMember_universal_d_ExtendedFields as ExtendedFields,
  ...
  type eventsV3Event_universal_d_RestoreInfo = RestoreInfo;
  ...
  namespace eventsV3Event_universal_d {
    export {
      ...
      eventsV3Event_universal_d_RestoreInfo as RestoreInfo,
