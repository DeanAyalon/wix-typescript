declare module "wix-loyalty.v2" {
  ...
  interface Reward$1 {
      /** reward that is expected to be used for this points -> coupon redeem */
      _id?: string;
      /** how points to use for the reward i.e. if reward is 10PT=1$, points_to_spend should be 35 for 3.5$ discount */
  ...
  interface LoyaltyCheckoutDiscountsQueryResult extends QueryCursorResult$3 {
   ...
   * You can ...
   * Read more about LoyaltyImports
  ...
  interface LoyaltyImport {
      ...
      /**
       * Revision number, which increments by 1 each time the `LoyaltyImport` is updated.
       * To prevent conflicting changes,
       * the current revision must be passed when updating the `LoyaltyImport`.
       *
       * Ignored when creating a `LoyaltyImport`.
       * @readonly
       */
      revision?: string | null;
      /**
       * Date and time the LoyaltyImport was created.
       * @readonly
       */
      _createdDate?: Date;
      /**
       * Date and time the LoyaltyImport was last updated.
       * @readonly
       */
      _updatedDate?: Date;
      /**
      ...
      /** Results of parsing the uploaded file */
  ...
  interface FileMetadata {
      ...
      /** Top 5 sample rows of the import */
  ...
  interface ParseResult {
      /**
       * Amount of rows that were parsed for uploaded import file
       * @readonly
       */
      parsedRowCount?: number | null;
      /**
       * Code of reason why parsing failed
       * @readonly
       */
      parseErrorReason?: string | null;
  }
  interface ImportResult {
      /** Whether an error file can be downloaded */
      errorFileExists?: boolean;
      /**
       * How many rows in the import were imported successfully
       * @readonly
       */
      successCount?: number | null;
      /**
       * How many rows in the import were not imported due to errors
       * @readonly
       */
  ...
  /**
   * Gets the download URL for the error file of a LoyaltyImport.
   * @public
   * @documentationMaturity preview
   * @requiredField loyaltyImportId
   * @adminMethod
  ...
  /**
   * Initiates a loyalty import that has already been created and the file parsed.
   * @public
   * @documentationMaturity preview
   * @requiredField loyaltyImportId
   * @adminMethod
  ...
  interface LoyaltyImportsQueryResult extends QueryCursorResult$2 {
      items: LoyaltyImport[];
  ...
  interface LoyaltyAccount {
       ...
       * @readonly
       * @deprecated Details of the account's latest transaction.
       * @replacedBy wix.loyalty.transaction.v1.loyalty_transaction
  ...
  interface LatestTransaction extends LatestTransactionTypeOptionsOneOf {
       ...
       * @internal
       * @readonly
       * @deprecated __Deprecated.__ For `latestTransaction.rewardId`, use `latestTransaction.redeemInfo.rewardId` instead. This property
       * will be removed on September 30, 2022.
       * @replacedBy redeem_info
       * @targetRemovalDate 2022-03-01
       */
  ...
  type loyaltyV1Coupon_universal_d_RestoreInfo = RestoreInfo;
  ...
  namespace loyaltyV1Coupon_universal_d {
    export {
      ...
      loyaltyV1Coupon_universal_d_RestoreInfo as RestoreInfo,
  ...
  /** LoyaltyEarningRule is the main entity of LoyaltyEarningRules that can be used for lorem ipsum dolor */
  interface LoyaltyEarningRule extends LoyaltyEarningRuleTypeOneOf {
      fixedAmount?: FixedAmount;
      conversionRate?: ConversionRate;
      /**
       * LoyaltyEarningRule ID (if source_app_id is automations it matches automation's ruleId)
       * @readonly
       */
      _id?: string | null;
      /** appDefId of the app managing the rule (currently can be either automations (rule as an automation) or loyalty (our custom earning-rule, managed by this service)) */
      sourceAppId?: string;
      /** appDefId of the app that triggers the points assignment */
      triggerAppId?: string;
      /** trigger's activityType (e.g. "wix-restaurants/orderSubmitted", "birthday", etc.) */
      ...
      revision?: string | null;
      /**
       * Represents the time this LoyaltyEarningRule was created
       * @readonly
       */
      _createdDate?: Date;
      /**
       * Represents the time this LoyaltyEarningRule was last updated
       * @readonly
       */
      _updatedDate?: Date;
      /** @readonly */
  ...
  interface FixedAmount {
       ...
       */
      points?: number;
      /** TODO after migration add [(wix.api.minSize) = 1] */
      configs?: FixedAmountConfig[];
  }
  interface FixedAmountConfig {
      /**
       * Tier ID, or None if base Tier
       * @readonly
       */
      tierId?: string | null;
      points?: number;
  ...
  interface ConversionRate {
      ...
      /** field to use to get sum used in calculations. Only applicable for automations. */
      field?: string | null;
  }
  interface ConversionRateConfig {
       ...
       */
      tierId?: string | null;
      /** amount required to earn points */
      moneyAmount?: number;
      /** points given for specified money_amount */
      points?: number;
  }
  enum Status$2 {
      UNKNOWN = "UNKNOWN",
  ...
  interface GetLoyaltyEarningRuleRequest {
      /** Id of the LoyaltyEarningRule to retrieve */
      _id: string;
  }
  interface GetLoyaltyEarningRuleResponse {
      /** The retrieved LoyaltyEarningRule */
      earningRule?: LoyaltyEarningRule;
  }
  interface GetAutomationEarningRuleRequest {
      /** Id of the AutomationsEarningRule to retrieve */
      _id: string;
  }
  interface GetAutomationEarningRuleResponse {
      /** The retrieved Automation Rule mapped as LoyaltyEarningRule */
      earningRule?: LoyaltyEarningRule;
  }
  ...
  interface UpdateLoyaltyEarningRuleResponse {
      /** The updated LoyaltyEarningRule */
      earningRule?: LoyaltyEarningRule;
  }
  interface DeleteLoyaltyEarningRuleRequest {
      /** Id of the LoyaltyEarningRule to delete */
      _id: string;
      /** The revision of the LoyaltyEarningRule */
      revision?: string;
  }
  interface DeleteLoyaltyEarningRuleResponse {
  }
  interface DeleteAutomationEarningRuleRequest {
      /** Id of the AutomationEarningRule to delete */
      _id: string;
  }
  ...
  interface ListEarningRulesInTierRequest {
      /** ID of the tier which earning rules will be returned. */
      tierId?: string | null;
      /** Pagination options. */
  ...
  /**
   * Creates a new LoyaltyEarningRule.
   * @param earningRule - LoyaltyEarningRule to be created
   * @public
   * @documentationMaturity preview
   * @requiredField earningRule
   * @adminMethod
   * @returns The created LoyaltyEarningRule
   */
  function createLoyaltyEarningRule(earningRule: LoyaltyEarningRule): Promise<LoyaltyEarningRule>;
  /**
   * Bulk create LoyaltyEarningRules.
   * @public
   * @documentationMaturity preview
   * @adminMethod
   */
  function bulkCreateLoyaltyEarningRules(options?: BulkCreateLoyaltyEarningRulesOptions): Promise<BulkCreateLoyaltyEarningRulesResponse>;
  interface BulkCreateLoyaltyEarningRulesOptions {
      earningRules?: LoyaltyEarningRule[];
  }
  /**
   * Get a LoyaltyEarningRule by id.
   * @param _id - Id of the LoyaltyEarningRule to retrieve
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   */
  function getLoyaltyEarningRule(_id: string): Promise<GetLoyaltyEarningRuleResponse>;
  /**
   * Get automation earning rule mapped as LoyaltyEarningRule by id.
   * @param _id - Id of the AutomationsEarningRule to retrieve
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   * @returns The retrieved Automation Rule mapped as LoyaltyEarningRule
   */
  function getAutomationEarningRule(_id: string): Promise<LoyaltyEarningRule>;
  /**
   * Update a LoyaltyEarningRule, supports partial update.
   *
   * Pass the latest `revision` for a successful update.
   * @param _id - LoyaltyEarningRule ID (if source_app_id is automations it matches automation's ruleId)
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   * @requiredField earningRule
  ...
  /**
   * Delete a LoyaltyEarningRule.
   * @param _id - Id of the LoyaltyEarningRule to delete
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   * @adminMethod
  ...
  /**
   * Delete a AutomationEarningRule.
   * @param _id - Id of the AutomationEarningRule to delete
   * @public
   * @documentationMaturity preview
   * @requiredField _id
   * @adminMethod
  ...
  type loyaltyV1LoyaltyEarningRule_universal_d_BulkCreateLoyaltyEarningRulesOptions = BulkCreateLoyaltyEarningRulesOptions;
  ...
  namespace loyaltyV1LoyaltyEarningRule_universal_d {
    export {
      ...
      loyaltyV1LoyaltyEarningRule_universal_d_BulkCreateLoyaltyEarningRulesOptions as BulkCreateLoyaltyEarningRulesOptions,
  ...
  interface Reward extends RewardTypeDetailsOneOf {
      ...
      /**
       * Custom reward (SPI implementation) details.
       * @internal
       */
  ...
  interface CustomReward {
      /** Discount details for each tier. */
      configsByTier?: DiscountAmountConfig[];
      /** Description of the custom reward. Taken from user input in the SPI config. */
      description?: string;
      /** Source of the custom reward. Can be "velo", "functions", etc. */
      source?: string;
  }
  ...
  type loyaltyV1Reward_universal_d_CustomReward = CustomReward;
  ...
  type loyaltyV1Reward_universal_d_UndeleteInfo = UndeleteInfo;
  ...
  namespace loyaltyV1Reward_universal_d {
    export {
      ...
      loyaltyV1Reward_universal_d_CustomReward as CustomReward,
      ...
      loyaltyV1Reward_universal_d_UndeleteInfo as UndeleteInfo,
