declare module "wix-metro-backend" {
  ...
  type metroinspectorV1Product_universal_d_DomainEvent = DomainEvent;
  type metroinspectorV1Product_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
  type metroinspectorV1Product_universal_d_EntityCreatedEvent = EntityCreatedEvent;
  type metroinspectorV1Product_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
  type metroinspectorV1Product_universal_d_EntityDeletedEvent = EntityDeletedEvent;
  type metroinspectorV1Product_universal_d_ActionEvent = ActionEvent;
  type metroinspectorV1Product_universal_d_MessageEnvelope = MessageEnvelope;
  type metroinspectorV1Product_universal_d_IdentificationData = IdentificationData;
  type metroinspectorV1Product_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
  type metroinspectorV1Product_universal_d_WebhookIdentityType = WebhookIdentityType;
  const metroinspectorV1Product_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
  ...
  namespace metroinspectorV1Product_universal_d {
    export {
      ...
      metroinspectorV1Product_universal_d_DomainEvent as DomainEvent,
      metroinspectorV1Product_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf,
      metroinspectorV1Product_universal_d_EntityCreatedEvent as EntityCreatedEvent,
      metroinspectorV1Product_universal_d_EntityUpdatedEvent as EntityUpdatedEvent,
      metroinspectorV1Product_universal_d_EntityDeletedEvent as EntityDeletedEvent,
      metroinspectorV1Product_universal_d_ActionEvent as ActionEvent,
      metroinspectorV1Product_universal_d_MessageEnvelope as MessageEnvelope,
      metroinspectorV1Product_universal_d_IdentificationData as IdentificationData,
      metroinspectorV1Product_universal_d_IdentificationDataIdOneOf as IdentificationDataIdOneOf,
      metroinspectorV1Product_universal_d_WebhookIdentityType as WebhookIdentityType,
