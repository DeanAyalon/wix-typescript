declare module "wix-multilingual.v2" {
  ...
  interface SchemasQueryResult extends QueryCursorResult$1 {
      items: Schema[];
  ...
  type multilingualGenericconverterV1EntityMapper_universal_d_FieldType = FieldType;
  const multilingualGenericconverterV1EntityMapper_universal_d_FieldType: typeof FieldType;
  ...
  type multilingualGenericconverterV1EntityMapper_universal_d_SchemaKey = SchemaKey;
  type multilingualGenericconverterV1EntityMapper_universal_d_SchemaScope = SchemaScope;
  const multilingualGenericconverterV1EntityMapper_universal_d_SchemaScope: typeof SchemaScope;
  ...
  namespace multilingualGenericconverterV1EntityMapper_universal_d {
    export {
      ...
      multilingualGenericconverterV1EntityMapper_universal_d_FieldType as FieldType,
      ...
      multilingualGenericconverterV1EntityMapper_universal_d_SchemaKey as SchemaKey,
      multilingualGenericconverterV1EntityMapper_universal_d_SchemaScope as SchemaScope,
  ...
  type multilingualTranslationV1Content_universal_d_CursorQuery = CursorQuery;
  type multilingualTranslationV1Content_universal_d_CursorQueryPagingMethodOneOf = CursorQueryPagingMethodOneOf;
  type multilingualTranslationV1Content_universal_d_Sorting = Sorting;
  type multilingualTranslationV1Content_universal_d_SortOrder = SortOrder;
  const multilingualTranslationV1Content_universal_d_SortOrder: typeof SortOrder;
  type multilingualTranslationV1Content_universal_d_CursorPaging = CursorPaging;
  type multilingualTranslationV1Content_universal_d_QueryContentsResponse = QueryContentsResponse;
  type multilingualTranslationV1Content_universal_d_CursorPagingMetadata = CursorPagingMetadata;
  type multilingualTranslationV1Content_universal_d_Cursors = Cursors;
  ...
  type multilingualTranslationV1Content_universal_d_MetaSiteSpecialEvent = MetaSiteSpecialEvent;
  type multilingualTranslationV1Content_universal_d_MetaSiteSpecialEventPayloadOneOf = MetaSiteSpecialEventPayloadOneOf;
  type multilingualTranslationV1Content_universal_d_Asset = Asset;
  type multilingualTranslationV1Content_universal_d_State = State;
  const multilingualTranslationV1Content_universal_d_State: typeof State;
  type multilingualTranslationV1Content_universal_d_SiteCreated = SiteCreated;
  type multilingualTranslationV1Content_universal_d_SiteCreatedContext = SiteCreatedContext;
  const multilingualTranslationV1Content_universal_d_SiteCreatedContext: typeof SiteCreatedContext;
  type multilingualTranslationV1Content_universal_d_Namespace = Namespace;
  const multilingualTranslationV1Content_universal_d_Namespace: typeof Namespace;
  type multilingualTranslationV1Content_universal_d_SiteTransferred = SiteTransferred;
  type multilingualTranslationV1Content_universal_d_SiteDeleted = SiteDeleted;
  type multilingualTranslationV1Content_universal_d_DeleteContext = DeleteContext;
  type multilingualTranslationV1Content_universal_d_DeleteStatus = DeleteStatus;
  const multilingualTranslationV1Content_universal_d_DeleteStatus: typeof DeleteStatus;
  type multilingualTranslationV1Content_universal_d_SiteUndeleted = SiteUndeleted;
  type multilingualTranslationV1Content_universal_d_SitePublished = SitePublished;
  type multilingualTranslationV1Content_universal_d_SiteUnpublished = SiteUnpublished;
  type multilingualTranslationV1Content_universal_d_SiteMarkedAsTemplate = SiteMarkedAsTemplate;
  type multilingualTranslationV1Content_universal_d_SiteMarkedAsWixSite = SiteMarkedAsWixSite;
  type multilingualTranslationV1Content_universal_d_ServiceProvisioned = ServiceProvisioned;
  type multilingualTranslationV1Content_universal_d_ServiceRemoved = ServiceRemoved;
  type multilingualTranslationV1Content_universal_d_SiteRenamed = SiteRenamed;
  type multilingualTranslationV1Content_universal_d_SiteHardDeleted = SiteHardDeleted;
  type multilingualTranslationV1Content_universal_d_NamespaceChanged = NamespaceChanged;
  type multilingualTranslationV1Content_universal_d_StudioAssigned = StudioAssigned;
  type multilingualTranslationV1Content_universal_d_StudioUnassigned = StudioUnassigned;
  type multilingualTranslationV1Content_universal_d_Empty = Empty;
  type multilingualTranslationV1Content_universal_d_DomainEvent = DomainEvent;
  type multilingualTranslationV1Content_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
  type multilingualTranslationV1Content_universal_d_EntityCreatedEvent = EntityCreatedEvent;
  type multilingualTranslationV1Content_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
  type multilingualTranslationV1Content_universal_d_EntityDeletedEvent = EntityDeletedEvent;
  type multilingualTranslationV1Content_universal_d_ActionEvent = ActionEvent;
  ...
  type multilingualTranslationV1Content_universal_d_MessageEnvelope = MessageEnvelope;
  type multilingualTranslationV1Content_universal_d_IdentificationData = IdentificationData;
  type multilingualTranslationV1Content_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
  type multilingualTranslationV1Content_universal_d_WebhookIdentityType = WebhookIdentityType;
  const multilingualTranslationV1Content_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
  ...
  namespace multilingualTranslationV1Content_universal_d {
    export {
      ...
      multilingualTranslationV1Content_universal_d_CursorQuery as CursorQuery,
      multilingualTranslationV1Content_universal_d_CursorQueryPagingMethodOneOf as CursorQueryPagingMethodOneOf,
      multilingualTranslationV1Content_universal_d_Sorting as Sorting,
      multilingualTranslationV1Content_universal_d_SortOrder as SortOrder,
      multilingualTranslationV1Content_universal_d_CursorPaging as CursorPaging,
      multilingualTranslationV1Content_universal_d_QueryContentsResponse as QueryContentsResponse,
      multilingualTranslationV1Content_universal_d_CursorPagingMetadata as CursorPagingMetadata,
      multilingualTranslationV1Content_universal_d_Cursors as Cursors,
      ...
      multilingualTranslationV1Content_universal_d_MetaSiteSpecialEvent as MetaSiteSpecialEvent,
      multilingualTranslationV1Content_universal_d_MetaSiteSpecialEventPayloadOneOf as MetaSiteSpecialEventPayloadOneOf,
      multilingualTranslationV1Content_universal_d_Asset as Asset,
      multilingualTranslationV1Content_universal_d_State as State,
      multilingualTranslationV1Content_universal_d_SiteCreated as SiteCreated,
      multilingualTranslationV1Content_universal_d_SiteCreatedContext as SiteCreatedContext,
      multilingualTranslationV1Content_universal_d_Namespace as Namespace,
      multilingualTranslationV1Content_universal_d_SiteTransferred as SiteTransferred,
      multilingualTranslationV1Content_universal_d_SiteDeleted as SiteDeleted,
      multilingualTranslationV1Content_universal_d_DeleteContext as DeleteContext,
      multilingualTranslationV1Content_universal_d_DeleteStatus as DeleteStatus,
      multilingualTranslationV1Content_universal_d_SiteUndeleted as SiteUndeleted,
      multilingualTranslationV1Content_universal_d_SitePublished as SitePublished,
      multilingualTranslationV1Content_universal_d_SiteUnpublished as SiteUnpublished,
      multilingualTranslationV1Content_universal_d_SiteMarkedAsTemplate as SiteMarkedAsTemplate,
      multilingualTranslationV1Content_universal_d_SiteMarkedAsWixSite as SiteMarkedAsWixSite,
      multilingualTranslationV1Content_universal_d_ServiceProvisioned as ServiceProvisioned,
      multilingualTranslationV1Content_universal_d_ServiceRemoved as ServiceRemoved,
      multilingualTranslationV1Content_universal_d_SiteRenamed as SiteRenamed,
      multilingualTranslationV1Content_universal_d_SiteHardDeleted as SiteHardDeleted,
      multilingualTranslationV1Content_universal_d_NamespaceChanged as NamespaceChanged,
      multilingualTranslationV1Content_universal_d_StudioAssigned as StudioAssigned,
      multilingualTranslationV1Content_universal_d_StudioUnassigned as StudioUnassigned,
      multilingualTranslationV1Content_universal_d_Empty as Empty,
      multilingualTranslationV1Content_universal_d_DomainEvent as DomainEvent,
      multilingualTranslationV1Content_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf,
      multilingualTranslationV1Content_universal_d_EntityCreatedEvent as EntityCreatedEvent,
      multilingualTranslationV1Content_universal_d_EntityUpdatedEvent as EntityUpdatedEvent,
      multilingualTranslationV1Content_universal_d_EntityDeletedEvent as EntityDeletedEvent,
      multilingualTranslationV1Content_universal_d_ActionEvent as ActionEvent,
      ...
      multilingualTranslationV1Content_universal_d_MessageEnvelope as MessageEnvelope,
      multilingualTranslationV1Content_universal_d_IdentificationData as IdentificationData,
      multilingualTranslationV1Content_universal_d_IdentificationDataIdOneOf as IdentificationDataIdOneOf,
      multilingualTranslationV1Content_universal_d_WebhookIdentityType as WebhookIdentityType,
