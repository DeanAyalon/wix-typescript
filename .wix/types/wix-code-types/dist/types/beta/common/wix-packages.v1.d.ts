declare module "wix-packages.v1" {
  ...
  interface UpdatePackageRequest {
      ...
      package?: Package;
      /**
       * Field Mask - the path to the updated field
       * @internal
       */
      fieldMask?: string[];
  }
   ...
   * [Create Package V2](https://dev.wix.com/api/rest/account-level-apis/resellers/packages/create-package-v2)
   ...
   * @adminMethod
   */
  function getPackage(_id: string): Promise<GetPackageResponse>;
  /**
   ...
   * @adminMethod
   */
  function queryPackages(query: QueryV2): Promise<QueryPackagesResponse>;
  /**
   ...
   * to in the header of the call.
   *
   * The product instance becomes floating and the customer immediately looses
  ...
  /**
   * This endpoint allows updating only the externalId field in a package.
   * An externalId is a field for the reseller to specify an id of their own to link to our package
   * required fields:
   * package must include packageId.
   * supported field masks:
   * [externalId]
   * Request:
   * - UpdatePackageRequest: Contains the package details to be updated.
   * - idempotencyKey: a unique key to guarantee the idempotency of the call
   * - package: The package object which must include the externalId field.
   * - fieldMask: A path for the for the externalId.
   * Response:
   * - UpdatePackageResponse: Confirmation of the updated package details.
   * - idempotencyKey: a unique key that was used to guarantee the idempotency of the call.
   * - package: The package object after the update.
   * @public
   * @documentationMaturity preview
   * @requiredField options.package._id
   * @adminMethod
   */
  function updatePackage(options?: UpdatePackageOptions): Promise<UpdatePackageResponse>;
  ...
  type premiumResellerV1Packages_universal_d_UpdatePackageRequest = UpdatePackageRequest;
  type premiumResellerV1Packages_universal_d_UpdatePackageResponse = UpdatePackageResponse;
  ...
  const premiumResellerV1Packages_universal_d_updatePackage: typeof updatePackage;
  type premiumResellerV1Packages_universal_d_UpdatePackageOptions = UpdatePackageOptions;
  ...
  namespace premiumResellerV1Packages_universal_d {
    export {
      ...
      premiumResellerV1Packages_universal_d_UpdatePackageRequest as UpdatePackageRequest,
      premiumResellerV1Packages_universal_d_UpdatePackageResponse as UpdatePackageResponse,
      ...
      premiumResellerV1Packages_universal_d_updatePackage as updatePackage,
      premiumResellerV1Packages_universal_d_UpdatePackageOptions as UpdatePackageOptions,
