declare module "wix-restaurants.v2" {
  interface Item extends ItemPricingOneOf {
       ...
       * Item price.
       * @internal
       * @deprecated Item price.
       * @replacedBy pricing.price_info.price
  ...
  namespace restaurantsMenusV1ItemLabel_universal_d {
    export {
      ...
      UndeleteInfo$5 as UndeleteInfo,
   ...
   *
   * If filter isn't passed in the request, the endpoint returns the count of all modifiers.
   * @public
   * @documentationMaturity preview
   */
   ...
   *
   * If filter isn't passed in the request, the endpoint returns the count of all modifier groups.
   * @public
   * @documentationMaturity preview
   */
   ...
   * > **Note:** The Item API only works with the Wix Restaurants Menus (New) app. Make sure you have installed this app from [Wix App Market](https://www.wix.com/app-market/wix-restaurants-menus-new).
   *
   * Retrieves the number of variants that match a specified filter.
   *
   * If filter isn't passed in the request, the endpoint returns the count of all variants.
   * @public
   * @documentationMaturity preview
   */
   ...
   * @requiredField query
   */
  function queryMenusSiteUrl(query: CursorQuery$4): Promise<QueryMenusSiteUrlResponse>;
  /**
  ...
  type restaurantsMenusV1Section_universal_d_UndeleteInfo = UndeleteInfo;
  ...
  namespace restaurantsMenusV1Section_universal_d {
    export {
      ...
      restaurantsMenusV1Section_universal_d_UndeleteInfo as UndeleteInfo,
