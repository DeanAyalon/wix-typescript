declare module "wix-rise.v2" {
  ...
  interface GiftCardsQueryBuilder {
       ...
       * @documentationMaturity preview
       */
      eq: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate', value: any) => GiftCardsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
      ne: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate', value: any) => GiftCardsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `value`.
       * @param value - Value to compare against.
       * @documentationMaturity preview
       */
       ...
       * @documentationMaturity preview
       */
      startsWith: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId', value: string) => GiftCardsQueryBuilder;
      /** @param propertyName - Property whose value is compared with `values`.
       * @param values - List of values to compare against.
       * @documentationMaturity preview
       */
      hasSome: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate', value: any[]) => GiftCardsQueryBuilder;
      /** @documentationMaturity preview */
      in: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate', value: any) => GiftCardsQueryBuilder;
      /** @documentationMaturity preview */
      exists: (propertyName: '_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate', value: boolean) => GiftCardsQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
      ascending: (...propertyNames: Array<'_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate'>) => GiftCardsQueryBuilder;
      /** @param propertyNames - Properties used in the sort. To sort by multiple properties, pass properties as additional arguments.
       * @documentationMaturity preview
       */
      descending: (...propertyNames: Array<'_id' | 'initialValue' | 'balance' | 'sourceInfo.type' | 'sourceInfo.sourceTenantId' | 'sourceInfo.sourceChannelId' | 'expirationDate' | '_createdDate' | '_updatedDate' | 'disableDate'>) => GiftCardsQueryBuilder;
  ...
  type riseV1WalletAction_universal_d_UndeleteInfo = UndeleteInfo;
  ...
  namespace riseV1WalletAction_universal_d {
    export {
      ...
      riseV1WalletAction_universal_d_UndeleteInfo as UndeleteInfo,
