declare module "wix-search.v2" {
  ...
  /**
   * Retrieves a list of items that match the provided search query.
   *
   * Use this endpoint to search the documents of a specific document type on a site. You can also use this endpoint to perform data aggregations on the specific document type.
   * @param documentType - Document type of the documents to search in.
   ...
   * @requiredField options.search
   */
  function search$1(documentType: DocumentType, language: string | null, options: SearchOptions$1): Promise<SearchResponse$1>;
