declare module "wix-stores.v3" {
  ...
  interface BulkSetOrIncrementInventoryItemsByFilterRequest {
      /**
       * Filter object in the following format:
       * `"filter" : {
       * "fieldName1": "value1",
  ...
  interface BulkSetOrIncrementInventoryItemsByFilterResponse {
      /** Guid token that can be used to query "AsyncJobService". */
      jobId?: string;
  }
  ...
  /**
   * Set or Increment inventory items which satisfy the provided filter..
   * The item track quantity, increment it's quantity,
   * In case non-tracking, updating it to track and setting quantity to `incrementBy`.
   * @param filter - Filter object in the following format:
   * `"filter" : {
   * "fieldName1": "value1",
   * "fieldName2":{"$operator":"value2"}
   ...
   * @adminMethod
   * @deprecated
   * @replacedBy BulkSetOrAdjustInventoryItemsByFilter
   */
  function bulkSetOrIncrementInventoryItemsByFilter(filter: Record<string, any> | null, options: BulkSetOrIncrementInventoryItemsByFilterOptions): Promise<BulkSetOrIncrementInventoryItemsByFilterResponse>;
  interface BulkSetOrIncrementInventoryItemsByFilterOptions {
      /** Quantity to increment by. */
      incrementBy: number;
  }
  /**
  ...
  type storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterRequest = BulkSetOrIncrementInventoryItemsByFilterRequest;
  type storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterResponse = BulkSetOrIncrementInventoryItemsByFilterResponse;
  ...
  const storesCatalogV3InventoryItem_universal_d_bulkSetOrIncrementInventoryItemsByFilter: typeof bulkSetOrIncrementInventoryItemsByFilter;
  type storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterOptions = BulkSetOrIncrementInventoryItemsByFilterOptions;
  ...
  namespace storesCatalogV3InventoryItem_universal_d {
    export {
      ...
      storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterRequest as BulkSetOrIncrementInventoryItemsByFilterRequest,
      storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterResponse as BulkSetOrIncrementInventoryItemsByFilterResponse,
      ...
      storesCatalogV3InventoryItem_universal_d_bulkSetOrIncrementInventoryItemsByFilter as bulkSetOrIncrementInventoryItemsByFilter,
      storesCatalogV3InventoryItem_universal_d_BulkSetOrIncrementInventoryItemsByFilterOptions as BulkSetOrIncrementInventoryItemsByFilterOptions,
