declare module "wix-subscription.v1" {
   ...
   * @adminMethod
   */
  function updateSubscriptionStartDate(_id: string, startDate: Date): Promise<UpdateSubscriptionStartDateResponse>;
  /**
   * Update subscription's payment method.
   * Supported only for recurring subscriptions or one time subscriptions during free trial.
   * @param _id - Subscription ID
   ...
   * @adminMethod
   */
  function updateSubscriptionBillingDate(_id: string, billingDate: Date, options?: UpdateSubscriptionBillingDateOptions): Promise<UpdateSubscriptionBillingDateResponse>;
