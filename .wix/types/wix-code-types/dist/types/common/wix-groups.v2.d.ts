declare module "wix-groups.v2" {
     ...
     * | `joinedDate`                | [`ascending()`](#membersquerybuilder/ascending), [`descending()`](/members-query-builder/descending)     |
     *
     *
     * @public
     * @requiredField groupId
    ...
    type socialGroupsV2GroupRoleRoles_universal_d_DomainEvent = DomainEvent;
    type socialGroupsV2GroupRoleRoles_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
    type socialGroupsV2GroupRoleRoles_universal_d_EntityCreatedEvent = EntityCreatedEvent;
    type socialGroupsV2GroupRoleRoles_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
    type socialGroupsV2GroupRoleRoles_universal_d_EntityDeletedEvent = EntityDeletedEvent;
    type socialGroupsV2GroupRoleRoles_universal_d_ActionEvent = ActionEvent;
    type socialGroupsV2GroupRoleRoles_universal_d_MessageEnvelope = MessageEnvelope;
    type socialGroupsV2GroupRoleRoles_universal_d_IdentificationData = IdentificationData;
    type socialGroupsV2GroupRoleRoles_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
    type socialGroupsV2GroupRoleRoles_universal_d_WebhookIdentityType = WebhookIdentityType;
    const socialGroupsV2GroupRoleRoles_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
