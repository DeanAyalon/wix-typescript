declare module "wix-loyalty.v2" {
    ...
    type loyaltyV1RewardRewards_universal_d_Coupon = Coupon;
    type loyaltyV1RewardRewards_universal_d_CouponConfig = CouponConfig;
    ...
    type loyaltyV1RewardRewards_universal_d_BulkGetRewardsOptions = BulkGetRewardsOptions;
    ...
    type loyaltyV1ProgramPrograms_universal_d_BulkGetLoyaltyProgramOptions = BulkGetLoyaltyProgramOptions;
    ...
    type loyaltyV1AccountAccounts_universal_d_LatestTransaction = LatestTransaction;
    type loyaltyV1AccountAccounts_universal_d_LatestTransactionTypeOptionsOneOf = LatestTransactionTypeOptionsOneOf;
    type loyaltyV1AccountAccounts_universal_d_TransactionType = TransactionType;
    const loyaltyV1AccountAccounts_universal_d_TransactionType: typeof TransactionType;
    type loyaltyV1AccountAccounts_universal_d_AdjustOptions = AdjustOptions;
    type loyaltyV1AccountAccounts_universal_d_EarnOptions = EarnOptions;
    type loyaltyV1AccountAccounts_universal_d_RedeemInfo = RedeemInfo;
    ...
    type loyaltyV1AccountAccounts_universal_d_GetTransactionRequest = GetTransactionRequest;
    type loyaltyV1AccountAccounts_universal_d_GetTransactionResponse = GetTransactionResponse;
    type loyaltyV1AccountAccounts_universal_d_Transaction = Transaction;
    type loyaltyV1AccountAccounts_universal_d_ListTransactionsRequest = ListTransactionsRequest;
    type loyaltyV1AccountAccounts_universal_d_ListTransactionsResponse = ListTransactionsResponse;
    ...
    const loyaltyV1AccountAccounts_universal_d_getTransaction: typeof getTransaction;
    const loyaltyV1AccountAccounts_universal_d_listTransactions: typeof listTransactions;
    type loyaltyV1AccountAccounts_universal_d_ListTransactionsOptions = ListTransactionsOptions;
